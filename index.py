                ...
                dbc.CardBody([
                    ...
                    dbc.Row([
                        dbc.Col([
                            ...
                            html.Legend("Crédito: Asimov Academy")
                        ])
                    ], style={'margin-top': '10px'}),
                    dbc.Row([
                        dbc.Button("Mais projetos", href="https://tudocomexcel.com.br/projetos-desenvolvidos/", target="_blank")
                    ], style={'margin-top': '10px'})
                ])
            ], style=tab_card)
        ], sm=4, lg=2),
...
def graph5(month, toggle):
    ...
    fig5.add_trace(go.Indicator(mode='number+delta',
        title = {"text": f"<span>{df_5['Consultor'].iloc[0]} - Top Consultant</span><br><span style='font-size:50%'>Em vendas - em relação a média</span><br>"},
    ...
    fig6.add_trace(go.Indicator(mode='number+delta',
        title = {"text": f"<span>{df_6['Equipe'].iloc[0]} - Top Team</span><br><span style='font-size:50%'>Em vendas - em relação a média</span><br>"},
...
def graph11(month, team, toggle):
    ...
    fig11.add_trace(go.Indicator(mode='number',
        title = {"text": f"<span style='font-size:120%'>Valor Total</span><br><span style='font-size:50%'>Em Reais</span><br>"},
